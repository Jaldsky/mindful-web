...
class AnalyticsTimelineInternalServerErrorSchema(InternalServerErrorSchema):
    """Схема ошибки 500 Internal Server Error для analytics timeline endpoint."""
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "message": "An unexpected error occurred while processing analytics timeline!",
                "details": None,
                "meta": {
